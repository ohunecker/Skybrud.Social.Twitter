...
namespace Skybrud.Social.Twitter.Responses.Statuses {
    ...
    public class TwitterGetStatusMessageResponse : TwitterResponse<TwitterStatusMessage> {
        ...
        private TwitterGetStatusMessageResponse(SocialHttpResponse response) : base(response) {
        ...
        public static TwitterGetStatusMessageResponse ParseResponse(SocialHttpResponse response) {
